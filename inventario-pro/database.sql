...
-- ─────────────────────────────────────────
-- 3. Stock mínimo configurable por producto (ya existe stock_minimo)
--    Agregar campo alerta_enviada para no repetir alertas
-- ─────────────────────────────────────────
ALTER TABLE productos
  ADD COLUMN alerta_stock TINYINT(1) DEFAULT 1;
